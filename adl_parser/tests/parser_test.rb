...
class ADLParserTest < Test::Unit::TestCase
  ...
  def test_parse
    laboratory_request = File.read('tests/openEHR-EHR-ITEM_TREE.Laboratory_request.v1.adl')
...
#      assert_equal '', result.definition
    ...
    apgar = File.read('tests/openEHR-EHR-OBSERVATION.apgar.v1.adl')
    assert_nothing_raised do
    ...
    evaluation = File.read('tests/openEHR-EHR-EVALUATION.adverse.v1.adl')
    assert_nothing_raised do
    ...
    referral = File.read('tests/openEHR-EHR-ITEM_TREE.referral.v1.adl')
    assert_nothing_raised do
      @parser.parse(referral, 'openEHR-EHR-ITEM_TREE.referral.v1.adl')
    end

    exam_fetus = File.read('tests/openEHR-EHR-CLUSTER.exam-fetus.v1.adl')
    assert_nothing_raised do
    ...
    imaging = File.read('tests/openEHR-EHR-ACTION.imaging.v1.adl')
    assert_nothing_raised do
    ...
    exam_generic = File.read('tests/openEHR-EHR-CLUSTER.exam-generic.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_generic, 'openEHR-EHR-CLUSTER.exam-generic.v1.adl')
    end
    exam_generic_mass = File.read('tests/openEHR-EHR-CLUSTER.exam-generic-mass.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_generic_mass, 'openEHR-EHR-CLUSTER.exam-generic-mass.v1.adl')
    end
    exam_generic_lymphnode = File.read('tests/openEHR-EHR-CLUSTER.exam-generic-lymphnode.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_generic_lymphnode, 'openEHR-EHR-CLUSTER.exam-generic-lymphnode.v1.adl')
    end
    exam_generic_joint = File.read('tests/openEHR-EHR-CLUSTER.exam-generic-joint.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_generic_joint, 'openEHR-EHR-CLUSTER.exam-generic-joint.v1.adl')
    end
    exam_chest = File.read('tests/openEHR-EHR-CLUSTER.exam-chest.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_chest, 'openEHR-EHR-CLUSTER.exam-chest.v1.adl')
    end
    exam_abdomen = File.read('tests/openEHR-EHR-CLUSTER.exam-abdomen.v1.adl')
    assert_nothing_raised do
      @parser.parse(exam_abdomen, 'openEHR-EHR-CLUSTER.exam-abdomen.v1.adl')
    end
    cluster_auscultation = File.read('tests/openEHR-EHR-CLUSTER.auscultation.v1.adl')
    assert_nothing_raised do
      @parser.parse(cluster_auscultation, 'openEHR-EHR-CLUSTER.auscultation.v1.adl')
    end
    cluster_auscultation_chest = File.read('tests/openEHR-EHR-CLUSTER.auscultation-chest.v1.adl')
    assert_nothing_raised do
      @parser.parse(cluster_auscultation_chest, 'openEHR-EHR-CLUSTER.auscultation-chest.v1.adl')
    end
    vital_signs = File.read('tests/openEHR-EHR-SECTION.vital_signs.v1.adl')
    assert_nothing_raised do
      @parser.parse(vital_signs, 'openEHR-EHR-SECTION.vital_signs.v1')
    end
    summary = File.read('tests/openEHR-EHR-SECTION.summary.v1.adl')
    assert_nothing_raised do
      @parser.parse(summary, 'openEHR-EHR-SECTION.summary.v1.adl')
    end

    findings = File.read('tests/openEHR-EHR-SECTION.findings.v1.adl')
    assert_nothing_raised do
      @parser.parse(findings, 'openEHR-EHR-SECTION.findings.v1.adl')
    end

    reason_for_encounter = File.read('tests/openEHR-EHR-SECTION.reason_for_encounter.v1.adl')
    assert_nothing_raised do
      @parser.parse(reason_for_encounter, 'openEHR-EHR-SECTION.reason_for_encounter.v1.adl')
    end

    imaging = File.read('tests/openEHR-EHR-ITEM_TREE.imaging.v1.adl')
    assert_nothing_raised do
      @parser.parse(imaging, 'openEHR-EHR-ITEM_TREE.imaging.v1.adl')
    end
    instruction_referral = File.read('tests/openEHR-EHR-INSTRUCTION.referral.v1.adl')
    assert_nothing_raised do
      @parser.parse(instruction_referral, 'openEHR-EHR-INSTRUCTION.referral.v1.adl')
    end
    instruction_medication = File.read('tests/openEHR-EHR-INSTRUCTION.medication.v1.adl')
    assert_nothing_raised do
      @parser.parse(instruction_medication, 'openEHR-EHR-INSTRUCTION.medication.v1.adl')
    end
    action_referral = File.read('tests/openEHR-EHR-ACTION.referral.v1.adl')
    assert_nothing_raised do
      @parser.parse(action_referral, 'openEHR-EHR-ACTION.referral.v1.adl')
    end

    dimensions_circumference = File.read('tests/openEHR-EHR-CLUSTER.dimensions.v1.adl')
    assert_nothing_raised do
      @parser.parse(dimensions_circumference, 'openEHR-EHR-CLUSTER.dimensions.v1.adl')
    end

    discharge = File.read('tests/openEHR-EHR-COMPOSITION.discharge.v1draft.adl')
    assert_nothing_raised do
      @parser.parse(discharge, 'openEHR-EHR-COMPOSITION.discharge.v1draft.adl')
    end

    encounter = File.read('tests/openEHR-EHR-COMPOSITION.encounter.v1draft.adl')
    assert_nothing_raised do
      @parser.parse(encounter, 'openEHR-EHR-COMPOSITION.encounter.v1draft.adl')
    end


#     medication = File.read('tests/openEHR-EHR-ITEM_TREE.medication.v1.adl')
#     assert_nothing_raised do
